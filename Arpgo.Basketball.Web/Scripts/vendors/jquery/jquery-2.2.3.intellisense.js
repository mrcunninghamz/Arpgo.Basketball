intellisense.annotate(jQuery, {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="context" type="Element">Document element to serve as the dbContext in which the HTML fragment will be created</param>
...
intellisense.annotate(jQuery.fn, {
  ...
  'init': function() {
    ...
    ///   <param name="context" type="">A DOM Element, Document, or jQuery to use as dbContext</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
